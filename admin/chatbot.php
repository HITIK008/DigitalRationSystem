      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li>
                      <a class="active" href="chatbot.php">
                    ...
                    <div class="panel-body">
                          <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    ?>
                                <button class="btn btn-info" data-toggle="modal" data-target="#post">+ Add New Query</button><br><br>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-lg-6">
                          ...
                          <table class="table table-striped table-hover table-bordered" id="myTable">
                              ...
                              <?php
                                $result = mysqli_query($con, "SELECT *FROM chatbot");
                                $i=1;
                              ...
                              <tr class="">
                                  ...
                                  <td><?php echo $data['replies']; ?></td>
                                   <td> <button class="btn btn-sm btn-outline-secondary badge" type="button" data-toggle="modal" data-target="#chatbot_edit<?php echo $data['id']?>">Edit</button>
                                    <a class="btn btn-sm btn-outline-secondary badge" type="button" href="chatbot_delete.php?id=<?php echo $data['id'];?>"><i class="fa fa-trash"></i></a></td>
                              </tr>
                              <?php include 'chatbot_edit.php'; }?>
                              </tbody>
                          </table>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h2 class="modal-title">Add New Query 
            ...
            <div class="panel-body">
                <form role="form" action="chatbot_query.php" method="POST">
                    <div class="form-group col-lg-12">
                        ...
                        <input type="text" class="form-control" name="queries" placeholder="Enter Here..." required>
                    </div>
                    <div class="form-group col-lg-12">
                        <label for="replies">Replies</label>
                        <input type="text" class="form-control" name="replies" placeholder="Enter Here..." required>
                    </div>                                 
