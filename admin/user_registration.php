  ...
  <section id="container" class="">
      ...
      <header class="header white-bg">
          ...
          <div class="nav notify-row" id="top_menu">
            ...
            <ul class="nav top-menu">
              <!-- settings start -->
              <li class="dropdown">
                  <a data-toggle="dropdown" class="dropdown-toggle" href="form_component.php#">
                  ...
                  <ul class="dropdown-menu extended tasks-bar">
                      ...
                      <li class="external">
                          <a href="form_component.php#">See All Tasks</a>
                      </li>
                  </ul>
              </li>
              <!-- settings end -->
              ...
              <ul class="nav pull-right top-menu">
                  ...
                  <li class="dropdown">
                      ...
                      <ul class="dropdown-menu extended logout">
                          ...
                          <li><a href="form_component.php#"><i class=" fa fa-suitcase"></i>Profile</a></li>
                          <li><a href="form_component.php#"><i class="fa fa-cog"></i> Settings</a></li>
                          <li><a href="form_component.php#"><i class="fa fa-bell-o"></i> Notification</a></li>
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          ...
                          <li><a  href="officer_record.php">Editable Table</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
              ...
              <div class="row">
                  ...
                  <div class="col-lg-6">
                      ...
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <a href="form_component.php#myModal" data-toggle="modal" class="btn btn-xs btn-success">
                                  Form in Modal
                              </a>
                              <a href="form_component.php#myModal-1" data-toggle="modal" class="btn btn-xs btn-warning">
                                  Form in Modal 2
                              </a>
                              <a href="form_component.php#myModal-2" data-toggle="modal" class="btn btn-xs btn-danger">
                                  Form in Modal 3
                              </a>
                      ...
                      <div class="row">
                          ...
                          <div class="col-lg-6">
                              <section class="panel">
                                  ...
                                  <div class="panel-body">
                                      <form action="form_component.php#" method="get" accept-charset="utf-8">
      ...
      <div class="sb-slidebar sb-right sb-style-overlay">
          ...
          <ul class="quick-chat-list">
              <li class="online">
                  <div class="media">
                      <a href="form_component.php#" class="pull-left media-thumb">
