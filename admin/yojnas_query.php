...
include '../includes/db.php';
    if(isset($_POST['submit']))
    {
        $content=$_POST['content'];
            ...
            if (!in_array($extension, ['pdf'])) {
                ...
                if (move_uploaded_file($file, $destination)) {
                    $sql = "INSERT INTO blog_yojnas (`content`, `pdf`, `pdf_name`) VALUES ('$content', '$size', '$filename')";
        ...
        // $result = mysqli_query($con,"INSERT INTO blog_yojnas (`content`,`url`) VALUES ('$content', '$url')");
...
<?php
    if(isset($_POST['edit']))
    {
        ...
        // $result = mysqli_query($con,"UPDATE `blog_yojnas` SET `content` = '$content', `url` = '$url' WHERE `id` = '$id';");
