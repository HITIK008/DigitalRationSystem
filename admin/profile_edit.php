                  ...
                  <aside class="profile-info col-lg-9">
                          ...
                          <div class="panel-body bio-graph-info">
                              ...
                              <form class="form-horizontal" role="form" action="adminupdate.php" method="POST">
                                  ...
                                  <div class="form-group">
                                      ...
                                      <div class="col-lg-6">
                                          <input type="text" class="form-control" name="mono" value="<?php echo $mono; ?>" pattern="[0-9]{10,10}" title="Enter 10 Digit Mobile Number"required>
                                      </div>
                                  </div>
                                  <div class="form-group">
                      ...
                      <section class="panel">
                          <div class="panel-body bio-graph-info">
                              ...
                              <form class="form-horizontal" role="form" action="adminupdate.php" method="POST" enctype="multipart/form-data">
                                  <div class="form-group">
