...
* Added support for deleting multiple users at once
  ...
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/user-management.php#delete-multiple-users))
### Changed
...
* Added support for Realtime Database Auth Variable Overrides
  ...
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/realtime-database.php#authenticate-with-limited-privileges))
* Added support for linking IdP credentials to an existing account
  ([#635](https://github.com/kreait/firebase-php/pull/635))
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/authentication.php#linking-and-unlinking-idp))
### Changes
...
* Added support for Session Cookie Generation
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/authentication.php#session-cookies))
...
* Helper methods to specify a message priority
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/cloud-messaging.php#message-priority))
### Changed
...
* It is now possible to validate multiple messages at once by adding a parameter to the `send*` Methods
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/cloud-messaging.php#validating-messages))
* It is now possible to check a list of registration tokens whether they are valid and known, unknown, or invalid
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/cloud-messaging.php#validating-registration-tokens))
* Added methods:
...
* The Auth component is now tenant-aware.
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/authentication.php#tenant-awareness))
* Added methods
...
* Added helper methods to add default/specific notification sounds to messages
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/cloud-messaging.php#notification-sounds))
...
* Added `Kreait\Firebase\Auth::getUsers()` enables retrieving multiple users at once.
  ...
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/user-management.php#get-information-about-multiple-users))
* Added support to sign in with Twitter OAuth credentials
  ([#481](https://github.com/kreait/firebase-php/pull/481))
* Added convenience method to sign in with IDP credentials ([Documentation](https://firebase-php.readthedocs.io/en/latest/authentication.php#sign-in-with-idp-credentials)):
...
* It is now possible to add/remove multiple topic subscriptions for multiple registration tokens.
  ...
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/cloud-messaging.php#topic-management))
...
* The RemoteConfig component now support Parameter Groups.
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/remote-config.php#parameter-groups))
...
* You can configure the behavior of the HTTP Client performing the API 
  ...
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/setup.php#http-client-options))
...
* User Records now contain the date and time when a user's password has last been updated.
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/user-management.php#user-records))
### Changed
...
* It is now possible to log outgoing HTTP requests and responses to the Firebase APIs. 
  ([Documentation](https://firebase-php.readthedocs.io/en/latest/setup.php#logging))
### Changed
