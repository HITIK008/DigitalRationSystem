...
This version added the [`form_params`](http://guzzle.readthedocs.org/en/latest/request-options.php#form_params)
and `multipart` request options. `form_params` is an associative array of
strings or array of strings and is used to serialize an
`application/x-www-form-urlencoded` POST request. The
[`multipart`](http://guzzle.readthedocs.org/en/latest/request-options.php#multipart)
...
See: http://docs.guzzlephp.org/en/latest/events.php
